    ...
    *,
    ...
    if activity_mode == "balanced":
        judgment_context = (
            ...
            "When session-scale displacement from the prior close is "
            "supplied, weigh its magnitude together with the shorter "
            "5-, 15-, and 30-minute moves.\n"
            "A small short-window move against a larger session-scale "
            "move does not automatically reverse the broader directional "
            "interpretation; compare both magnitude and time horizon.\n"
